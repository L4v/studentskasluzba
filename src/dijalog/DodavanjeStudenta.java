...
public class DodavanjeStudenta extends JDialog{
	...
	public DodavanjeStudenta() {
		...
		c16.gridx = 1;
		c16.gridy = 10;
		c16.insets = new Insets(2, 2, 2, 2);
		c16.anchor = GridBagConstraints.WEST;
		getContentPane().add(otkazi, c16);
		
		GridBagConstraints c17 = new GridBagConstraints();
		c17.gridx = 1;
		c17.gridy = 10;
		c17.insets = new Insets(2, 2, 2, 2);
		c17.anchor = GridBagConstraints.EAST;
		getContentPane().add(potvrdi, c17);
