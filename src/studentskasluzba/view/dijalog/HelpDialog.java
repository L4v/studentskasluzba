...
public class HelpDialog extends JDialog {
	...
	public HelpDialog() {
		...
		JLabel labela = new JLabel( 
				...
				+ "<br/><br/>"
				+ "Klikom na tab 'Studenti' prikazana je tabela svih studenata. Kada se odabere tab 'Profesori' prikazuje se tabela sa svim profesorima, "
				...
				+ "Za dodavanje profesora na predmet potrebno je oti\u0107i na tab 'Predmeti' i kliknuti na \u010detvrto dugme i u dijalogu uneti broj li\u010dne karte profesora kojeg \u017eelimo dodati. "
