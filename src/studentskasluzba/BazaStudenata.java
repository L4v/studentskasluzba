...
public class BazaStudenata {
	...
	private BazaStudenata()
	{
		...
		Student st1 = new Student("Petar", "Petrovi\u0106", "09.01.1998","Njego\u0161eva 50","021936001","petar.petrovic@mail.com","RA350/17","05.07.2017","3",Status.B,9.12);
		Student st2 = new Student("Marko", "Markovi\u0106","20.06.1999","Tolstojeva 33","021072632","marko.markovic99@mail.com","RA333/18","04.07.2018","2",Status.S,8.69);
		Student st3 = new Student("Jovana", "Jovanovi\u0106", "07.10.2000","\u0161ekspirova 10","021798165","jovana.jovanovic123@mail.com","RA367/19","06.07.2019","1",Status.B,9.50);
		torke.add(st1);
		torke.add(st2);
		torke.add(st3);
	}
	...
	public String getValueAt(int row, int column)
	{
		...
		switch(column)
		{
			...
			case 4:
			{
				if (Result.getStatusStudenta()==Status.B)
					return "B";
				else
					return "S";
			}
